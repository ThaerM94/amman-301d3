...
function displayPics(){
  ...
  // Ans : because we declared the 'rondo' inside the code block of while loop soo it's local variable , to console it we should make a console inside the code block. 
  console.log(viewed);
